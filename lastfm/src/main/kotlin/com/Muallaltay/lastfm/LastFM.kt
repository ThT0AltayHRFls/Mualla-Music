...
package moe.rukamori.mualla.lastfm
...
import moe.rukamori.mualla.lastfm.models.Authentication
import moe.rukamori.mualla.lastfm.models.LastFmError
import moe.rukamori.mualla.lastfm.models.TokenResponse
import java.net.URI
...
object LastFM {
    ...
    const val FALLBACK_COMPAT_API_KEY = "mualla"
    const val FALLBACK_COMPAT_SECRET = "mualla"
    ...
    private fun HttpRequestBuilder.lastfmParams(
        ...
        headers.append(HttpHeaders.UserAgent, "Mualla-Music (https://github.com/ThT0AltayHR/Mualla-Music)")
        val paramsForSig =
            mutableMapOf(
                "method" to method,
                "api_key" to apiKey,
