...
import com.Muallaltay.extensions.toggleRepeatMode
...
import com.Muallaltay.ui.component.MediaMetadataListItem
import com.Muallaltay.ui.component.TextFieldDialog
import com.Muallaltay.ui.menu.AddToPlaylistDialog
import com.Muallaltay.ui.menu.PlayerMenu
import com.Muallaltay.ui.utils.ShowMediaInfo
import com.Muallaltay.utils.oem.SystemMediaControlResolver
...
fun Queue(
    ...
    val togetherForcesLock =
        togetherSessionState is com.Muallaltay.together.TogetherSessionState.Joined &&
            (togetherSessionState as com.Muallaltay.together.TogetherSessionState.Joined).role is com.Muallaltay.together.TogetherRole.Guest
                                                    ...
                                                    onClick = {
                                                        if (selection) {
                                                            ...
                                                            if (index == currentWindowIndex) {
                                                                ...
                                                                val joined =
                                                                    togetherSessionState as? com.Muallaltay.together.TogetherSessionState.Joined
                                                                val isGuest = joined?.role is com.Muallaltay.together.TogetherRole.Guest
                                                                if (isGuest) {
