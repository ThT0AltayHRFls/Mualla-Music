...
import com.Muallaltay.viewmodels.LogcatEffect
import com.Muallaltay.viewmodels.LogcatScreenState
import com.Muallaltay.viewmodels.LogcatUiEntries
            ...
            when (effect) {
                ...
                is LogcatEffect.Export -> {
                    val exportIntent =
                        Intent(Intent.ACTION_SEND).apply {
                            type = "text/plain"
                            clipData = ClipData.newRawUri("mualla-log.txt", effect.uri)
