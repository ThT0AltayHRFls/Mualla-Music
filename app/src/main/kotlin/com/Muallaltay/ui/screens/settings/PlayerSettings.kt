...
import com.Muallaltay.constants.LowDataModeKey
...
import com.Muallaltay.constants.SeekExtraSeconds
...
import com.Muallaltay.ui.component.ArtistSeparatorsDialog
import com.Muallaltay.ui.component.CrossfadeSliderPreference
...
import com.Muallaltay.ui.component.SliderPreference
import com.Muallaltay.ui.component.SwitchPreference
import com.Muallaltay.ui.component.TagsManagementDialog
import com.Muallaltay.ui.component.TextFieldDialog
                    ...
                    ListPreference(
                        ...
                        valueText = {
                            when (it) {
                                ...
                                PlayerStreamClient.ARCHIVETUNE_EXTRACTOR -> {
                                    stringResource(
                                        R.string.player_stream_client_mualla_extractor,
                                    )
                                }
                            ...
                            when (it) {
                                ...
                                PlayerStreamClient.ARCHIVETUNE_EXTRACTOR -> {
                                    if (isMualla-MusicExtractorEnabled) {
                                        ...
                                        stringResource(
                                            R.string.player_stream_client_mualla_extractor_login_required,
                                        )
                                    }
                                }
