...
sealed interface TogetherClientEvent {
    ...
    data class JoinDecision(
        val decision: com.Muallaltay.together.JoinDecision,
    ) : TogetherClientEvent

    data class HostTransferred(
        val transfer: com.Muallaltay.together.HostTransferred,
    ) : TogetherClientEvent
    ...
    data class HeartbeatPong(
        val pong: com.Muallaltay.together.HeartbeatPong,
                ...
                try {
                    while (true) {
                        ...
                        when (message) {
                            ...
                            is com.Muallaltay.together.JoinDecision -> {
                            ...
                            is com.Muallaltay.together.HostTransferred -> {
                                if (message.sessionId == sessionId) {
