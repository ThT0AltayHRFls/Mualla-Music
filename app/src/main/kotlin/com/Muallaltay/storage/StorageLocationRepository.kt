...
package com.Muallaltay.storage
...
import com.Muallaltay.constants.GitHubContributorsEtagKey
import com.Muallaltay.constants.GitHubContributorsJsonKey
import com.Muallaltay.constants.GitHubContributorsLastCheckedAtKey
import com.Muallaltay.constants.GitHubTranslationContributorsJsonKey
import com.Muallaltay.constants.GitHubTranslationContributorsLastCheckedAtKey
import com.Muallaltay.constants.StorageFolderDisplayNameKey
import com.Muallaltay.constants.StorageFolderIdKey
import com.Muallaltay.constants.StorageFolderPathKey
import com.Muallaltay.constants.StorageFolderTreeUriKey
...
private fun File.ensureWritableDirectory(): Boolean =
    runCatching {
        ...
        val probe = File(this, ".mualla-storage-probe")
        probe.writeText("ok")
        probe.delete()
    }.isSuccess
...
private const val ExternalStorageRootDirectoryName = "Mualla-Music"
...
private const val SavedArtworkCacheFileName = "mualla_saved_artworks.json"
