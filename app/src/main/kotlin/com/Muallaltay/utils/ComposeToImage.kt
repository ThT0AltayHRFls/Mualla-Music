...
import com.Muallaltay.ui.component.LyricsShareImageOptions
import java.io.File
...
object ComposeToImage {
    ...
    suspend fun createLyricsImage(
        ...
        glassStyle: com.Muallaltay.ui.component.LyricsGlassStyle? = null,
        shareOptions: LyricsShareImageOptions = LyricsShareImageOptions(),
    ): Bitmap =
        withContext(Dispatchers.Default) {
            val style = glassStyle ?: com.Muallaltay.ui.component.LyricsGlassStyle.FrostedDark
            ...
            // Watermark removed - Mualla-Music branding kept clean
    ...
    // AppLogo function removed - Watermark removed for cleaner sharing
        ...
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            val contentValues =
                ContentValues().apply {
                    ...
                    put(MediaStore.MediaColumns.RELATIVE_PATH, Environment.DIRECTORY_PICTURES + "/Mualla-Music")
                }
            val uri =
