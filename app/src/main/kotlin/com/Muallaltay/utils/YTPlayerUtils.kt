...
import com.Muallaltay.innertube.NewPipeUtils
import com.Muallaltay.innertube.PlaybackAuthState
import com.Muallaltay.innertube.YouTube
import com.Muallaltay.innertube.models.YouTubeClient
import com.Muallaltay.innertube.models.YouTubeClient.Companion.ANDROID_CREATOR
import com.Muallaltay.innertube.models.YouTubeClient.Companion.ANDROID_MUSIC
import com.Muallaltay.innertube.models.YouTubeClient.Companion.ANDROID_TESTSUITE
import com.Muallaltay.innertube.models.YouTubeClient.Companion.ANDROID_UNPLUGGED
import com.Muallaltay.innertube.models.YouTubeClient.Companion.ANDROID_VR_1_65_10
import com.Muallaltay.innertube.models.YouTubeClient.Companion.IOS
import com.Muallaltay.innertube.models.YouTubeClient.Companion.IOS_MUSIC
import com.Muallaltay.innertube.models.YouTubeClient.Companion.IPADOS
import com.Muallaltay.innertube.models.YouTubeClient.Companion.MOBILE
import com.Muallaltay.innertube.models.YouTubeClient.Companion.TVHTML5
import com.Muallaltay.innertube.models.YouTubeClient.Companion.TVHTML5_SIMPLY_EMBEDDED_PLAYER
import com.Muallaltay.innertube.models.YouTubeClient.Companion.VISIONOS
import com.Muallaltay.innertube.models.YouTubeClient.Companion.WEB
import com.Muallaltay.innertube.models.YouTubeClient.Companion.WEB_CREATOR
import com.Muallaltay.innertube.models.YouTubeClient.Companion.WEB_PRIMARY
import com.Muallaltay.innertube.models.YouTubeClient.Companion.WEB_REMIX
import com.Muallaltay.innertube.models.response.PlayerResponse
import com.Muallaltay.utils.potoken.BotGuardTokenGenerator
import com.Muallaltay.utils.potoken.PoTokenResult
...
object YTPlayerUtils {
     ...
     *
     * [com.Muallaltay.innertube.models.YouTubeClient.WEB_REMIX] should be preferred here because currently it is the only client which provides:
    ...
    private suspend fun repairAuthStateAfterBotDetection(
        ...
        if (!hasCompleteWebPlaybackPoToken(repairedAuthState)) {
    ...
    private suspend fun playerResponseForPlaybackOnce(
        ...
        var metadataPoToken = authState.resolvePlayerPoToken(metadataClient)
        ...
        if (metadataFailure != null && canUseLoggedInPlayback && metadataFailure.isInvalidPlaybackLoginContextFailure()) {
            ...
            if (metadataClient.useWebPoTokens && newSessionId != null) {
                try {
                    authState = mintWebPlaybackPoTokens(videoId, authState)
                    metadataPoToken = authState.resolvePlayerPoToken(metadataClient)
                } catch (cancellation: CancellationException) {
                    throw cancellation
                } catch (e: Exception) {
    ...
    suspend fun playerResponseForMetadata(
        ...
        return YouTube
            .player(
                ...
                client = MAIN_CLIENT,
                signatureTimestamp = signatureTimestamp,
                poToken = resolvedAuthState.resolvePlayerPoToken(MAIN_CLIENT),
                setLogin = true,
