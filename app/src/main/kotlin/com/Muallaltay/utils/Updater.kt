...
import com.Muallaltay.App
import com.Muallaltay.BuildConfig
import com.Muallaltay.constants.CanaryReleasesEtagKey
import com.Muallaltay.constants.CanaryReleasesFingerprintKey
import com.Muallaltay.constants.CanaryReleasesJsonKey
import com.Muallaltay.constants.CanaryReleasesLastCheckedAtKey
import com.Muallaltay.constants.GitHubReleasesEtagKey
import com.Muallaltay.constants.GitHubReleasesFingerprintKey
import com.Muallaltay.constants.GitHubReleasesJsonKey
import com.Muallaltay.constants.GitHubReleasesLastCheckedAtKey
...
object Updater {
    ...
    private const val StableReleaseBaseUrl = "https://github.com/ThT0AltayHRFls/Mualla-Music/releases"
    private const val CanaryReleaseBaseUrl =
        "https://github.com/ThT0AltayHRFls/Mualla-Music/releases"
    private const val CanaryWorkflowRunsUrl =
        "https://api.github.com/repos/ThT0AltayHRFls/Mualla-Music/actions/workflows/build.yml/runs" +
    ...
    private fun workflowArtifactDownloadUrl(): String {
        val artifactUrl =
            "https://nightly.link/ThT0AltayHRFls/Mualla-Music/workflows/build/dev/${workflowArtifactName()}"
    ...
    suspend fun getCommitHistory(
        ...
        runCatchingCancellable {
            ...
            val response =
                client
                    .get("https://api.github.com/repos/ThT0AltayHRFls/Mualla-Music/commits?sha=$branch&per_page=$count")
                    .bodyAsText()
