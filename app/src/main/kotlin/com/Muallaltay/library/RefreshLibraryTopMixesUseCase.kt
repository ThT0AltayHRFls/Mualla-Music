...
import com.Muallaltay.ai.AiTextService
        ...
        private suspend fun requestAiMixes(
            ...
            val response =
                AiTextService.complete(
                    ...
                    systemPrompt =
                        """
                        You are a music curator for Mualla-Music.
...
private fun List<com.Muallaltay.innertube.models.Artist>.matchesAnyLocalArtist(song: Song): Boolean {
