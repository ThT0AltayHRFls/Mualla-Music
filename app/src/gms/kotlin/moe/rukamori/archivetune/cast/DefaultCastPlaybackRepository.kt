...
private class GmsCastMediaItemConverter(
    ...
    private fun MediaInfo?.toAppMediaMetadata(mediaId: String): com.Muallaltay.models.MediaMetadata {
        val castMetadata = this?.metadata
        val title = castMetadata?.stringValue(CastMetadata.KEY_TITLE) ?: mediaId
        val artistText =
        ...
        return com.Muallaltay.models.MediaMetadata(
            ...
            album =
                albumTitle?.let {
                    com.Muallaltay.models.MediaMetadata.Album(
                        id = it,
                        title = it,
                    )
                },
    ...
    private fun openResolvedRemoteSource(
        ...
        val connection =
            (URL(resolvedUri.toString()).openConnection() as HttpURLConnection).apply {
                ...
                setRequestProperty("User-Agent", "Mualla-Music Cast")
