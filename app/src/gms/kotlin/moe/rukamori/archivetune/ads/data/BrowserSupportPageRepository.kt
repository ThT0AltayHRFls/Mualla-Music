...
package com.Muallaltay.ads.data
...
import com.Muallaltay.ads.domain.SupportPageRepository
...
internal class BrowserSupportPageRepository
    ...
    constructor(
        ...
        private fun supportPageUnavailable(exception: RuntimeException): SupportPageOpenResult {
            Timber.w(exception, "Unable to open the Mualla-Music support page")
            return SupportPageOpenResult.Unavailable
        }

        private companion object {
            val SUPPORT_PAGE_URI: Uri = Uri.parse("https://mualla.koiiverse.cloud/support")
        }
    }
